...
namespace Example
{
   ...
   {
        public StageMasterTable StageMasterTable { get; private set; }

        public MemoryDatabase(
            StageMasterTable StageMasterTable
        )
        {
            this.StageMasterTable = StageMasterTable;
        }
        ...
        {
            this.StageMasterTable = ExtractTableData<StageMaster, StageMasterTable>(header, databaseBinary, options, xs => new StageMasterTable(xs));
        }
        ...
        public DatabaseBuilder ToDatabaseBuilder()
        {
            ...
            builder.Append(this.StageMasterTable.GetRawDataUnsafe());
            return builder;
        }
        ...
        public ValidateResult Validate()
        {
            ...
            ((ITableUniqueValidate)StageMasterTable).ValidateUnique(result);
            ValidateTable(StageMasterTable.All, database, "Id", StageMasterTable.PrimaryKeySelector, result);
        ...
        public static MasterMemory.Meta.MetaDatabase GetMetaDatabase()
        {
            ...
            dict.Add("Stage", Example.Tables.StageMasterTable.CreateMetaTable());
